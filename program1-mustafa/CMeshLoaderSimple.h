...
class CMeshLoader
{
	 ...
	 */
	static void createVertexBufferObject(CMesh const & Mesh, int & TriangleCount,
                                           GLuint & PositionBufferHandle,
                                           GLuint & ColorBufferHandle);
	
	static void createVertexBufferObjectNPF(CMesh const & Mesh, int & TriangleCount,
                                              GLuint & PositionBufferHandle,
                                              GLuint & NormalBufferHandle,
                                              GLuint & ColorBufferHandle);

  static void calculateNormalsPV(CMesh const & Mesh, GLuint &NormalBufferHandle);

public:

	static bool loadVBOFromMesh(std::string const & fileName,
	                                           int & TriangleCount,
	                                           GLuint & PositionBufferHandle,
	                                           GLuint & ColorBufferHandle);
	...
	static bool loadVBOFromMeshNPF(std::string const & fileName,
                                               int & TriangleCount,
                                               GLuint & PositionBufferHandle,
                                               GLuint & NormalBufferHandle,
                                               GLuint & ColorBufferHandle);
