...
<title>text01_intro/text.v.glsl - modern-tutorials in Wikibooks OpenGL - Gitorious</title>
...
<div class="page-meta">
  <ul class="page-actions">
    <li>Blob contents</li>
    <li><a href="/wikibooks-opengl/modern-tutorials/blobs/blame/9d4feea61db73635db32ec0162da689da6ae8549/text01_intro/text.v.glsl" class="blame js-pjax" data-pjax="#codeblob">Blame</a></li>
    <li><a href="/wikibooks-opengl/modern-tutorials/blobs/history/master/text01_intro/text.v.glsl" class="js-pjax" data-pjax="#codeblob">Blob history</a></li>
    <li><a href="/wikibooks-opengl/modern-tutorials/blobs/raw/master/text01_intro/text.v.glsl">Raw blob data</a></li>
  </ul>
</div>
...
<td class="code"><pre class="prettyprint lang-glsl">attribute vec4 coord;</pre></td>
</tr>
<tr id="line2">
...
<td class="code"><pre class="prettyprint lang-glsl">  gl_Position = vec4(coord.xy, 0, 1);</pre></td>
</tr>
<tr id="line6">
<td class="line-numbers"><a href="#line6" name="line6">6</a></td>
<td class="code"><pre class="prettyprint lang-glsl">  texpos = coord.zw;</pre></td>
</tr>
<tr id="line7">
